(function d3ChartIIFE() {
	...
	const isInternetExplorer = window.navigator.userAgent.indexOf("MSIE") > -1 || window.navigator.userAgent.indexOf("Trident") > -1,
		...
		cssLinks = ["https://cbpfgms.github.io/css/d3chartstyles-stg.css", "https://cbpfgms.github.io/css/d3chartstylespbiolc-stg.css", fontAwesomeLink],
	...
	function d3Chart() {
		...
		const width = 900,
			...
			classPrefix = "pbiolc",
			dataFileUrl = "https://cbpfapi.unocha.org/vo2/odata/PoolFundBeneficiarySummary?$format=csv&ShowAllPooledFunds=1",
