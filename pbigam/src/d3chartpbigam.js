(function d3ChartIIFE() {
	const isInternetExplorer =
		...
		cssLinks = [
			...
			"https://cbpfgms.github.io/css/d3chartstylespbigam.css",
			fontAwesomeLink,
		],
	...
	function d3Chart() {
		...
		const width = 900,
			...
			dataFile =
				"https://cbpfapi.unocha.org/vo2/odata/ProjectGAMSummary?PoolfundCodeAbbrv=&$format=csv",
			metadataFile =
		...
		function createTopPanel(data, masterRegionalFunds) {
			...
			topPanelRhpfsText
				.append("tspan")
				.attr("class", "pbigaminfoIcon contributionColorFill")
				.text(" \uf05a");
			...
			function mouseOverTopPanelRfText() {
				...
				const fundsDiv = innerTooltip
					...
					.enter()
					.append("div")
					.attr("class", "pbigamFundsDiv");

				fundsDiv
					.append("div")
					.attr("class", "pbigamfundsDivTitle")
					.html(function (d) {
						return d.rfName;
					});
