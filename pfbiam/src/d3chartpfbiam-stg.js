...
Promise.all([fetchFile("unworldmap", unworldmapUrl, "world map", "json"),
		...
		fetchFile((showClosedFunds ? "allocationsDataClosedFunds" : "allocationsData"),
			(showClosedFunds ? allocationsDataUrlClosedFunds : allocationsDataUrl),
			"allocations data" + (showClosedFunds ? " (with closed funds)" : ""), "csv")
	])
...
function createAllocations(colors, mapData, lists) {
	...
	const outerDiv = chartContainerDiv.append("div")
	...
	const venezuelaDisclaimerDiv = mapDiv.append("div")
