...
export const projectSummaryObjectSchema = z.object({
	...
	StartDate: z.date(),
	PrjApprDate: z.date().nullable(), //TEMPORARY
...
export const allocationTypesMasterObjectSchema = z.object({
	...
	AllocationHCLastProjectApprovalDate: z.date().nullable(),
...
export const organizationMasterObjectSchema = z.object({
	...
	EligibleSince: z.date().nullable(),
	FirstAllocationDate: z.date().nullable(),
